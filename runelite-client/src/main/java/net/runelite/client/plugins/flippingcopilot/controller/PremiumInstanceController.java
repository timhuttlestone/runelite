...
import net.runelite.client.plugins.flippingcopilot.model.PremiumInstanceStatus;
import net.runelite.client.plugins.flippingcopilot.model.SuggestionManager;
import net.runelite.client.plugins.flippingcopilot.ui.PremiumInstancePanel;
