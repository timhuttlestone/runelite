...
import net.runelite.client.plugins.flippingcopilot.manager.PriceGraphConfigManager;
...
import net.runelite.client.plugins.flippingcopilot.ui.graph.model.Constants;
import net.runelite.client.plugins.flippingcopilot.ui.graph.model.Data;
...
public class PriceGraphController {
    ...
    private final JLabel itemIcon = new JLabel(new ImageIcon(ImageUtil.loadImageResource(getClass(),"/net/runelite/client/plugins/flippingcopilot/small_open_arrow.png")));
    ...
    private void showGraphView(String itemName, Data data) {
        ...
        try {
            BufferedImage gearIcon = ImageUtil.loadImageResource(PriceGraphController.class, "/net/runelite/client/plugins/flippingcopilot/preferences-icon.png");
