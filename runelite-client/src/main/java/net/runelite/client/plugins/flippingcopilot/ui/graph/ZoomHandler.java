...
import net.runelite.client.plugins.flippingcopilot.ui.graph.model.Config;
...
public class ZoomHandler {
    ...
    public void drawButtons(Graphics2D plotAreaG2, PlotArea pa, Point p) {
        ...
        plotAreaG2.setColor(Color.WHITE);
        plotAreaG2.setStroke(new BasicStroke(1.5f));
        ...
        // Draw + symbol
        plotAreaG2.setColor(Color.WHITE);
        plotAreaG2.setStroke(new BasicStroke(2.0f));
