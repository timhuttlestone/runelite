...
import net.runelite.client.plugins.flippingcopilot.ui.graph.model.*;
...
public class RenderV2 {
    ...
    public void drawYAxisLabels(Graphics2D g2, Config config, PlotArea pa, PriceAxis yAxis) {
        ...
        for (int price : yAxis.tickPrices) {
            ...
            String label = net.runelite.client.plugins.flippingcopilot.ui.UIUtilities.quantityToRSDecimalStack(price, true);
            g2.drawString(label,
    ...
    public void drawLines(Graphics2D plotAreaG2,
        ...
        Shape originalClip = plotAreaG2.getClip();
