...
import net.runelite.client.plugins.flippingcopilot.controller.*;
import net.runelite.client.plugins.flippingcopilot.manager.CopilotLoginManager;
import net.runelite.client.plugins.flippingcopilot.model.*;
import net.runelite.client.plugins.flippingcopilot.ui.components.AccountDropdown;
import net.runelite.client.plugins.flippingcopilot.ui.components.IntervalDropdown;
import net.runelite.client.plugins.flippingcopilot.ui.flipsdialog.FlipsDialogController;
...
public class StatsPanelV2 extends JPanel {
    ...
    public final BufferedImage TRASH_ICON = ImageUtil.loadImageResource(getClass(), "/net/runelite/client/plugins/flippingcopilot/trash.png");
    public final BufferedImage ARROW_ICON = ImageUtil.loadImageResource(getClass(),"/net/runelite/client/plugins/flippingcopilot/small_open_arrow.png");
    ...
    public final BufferedImage FLIPS_DIALOG_ICON = ImageUtil.recolorImage(ImageUtil.resizeImage(ImageUtil.loadImageResource(getClass(),"/net/runelite/client/plugins/flippingcopilot/popout-flips.png"), 20, 20),ColorScheme.LIGHT_GRAY_COLOR);
