...
public class Icons {
    ...
    static
    {
        final BufferedImage openIcon = ImageUtil
                .loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/small_open_arrow.png");
        ...
        final BufferedImage resetIcon = ImageUtil
                .loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/reset.png");
        RESET_ICON = new ImageIcon(resetIcon);
        RESET_HOVER_ICON = new ImageIcon(ImageUtil.alphaOffset(resetIcon, 0.53f));

        final BufferedImage deleteIcon = ImageUtil
                .loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/delete_icon.png");
        DELETE_ICON = new ImageIcon(deleteIcon);

        final BufferedImage settingsIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/settings_icon.png");
        SETTINGS_ICON = new ImageIcon(settingsIcon);
        SETTINGS_ICON_OFF = new ImageIcon(ImageUtil.alphaOffset(settingsIcon, 0.53f));

        final BufferedImage accountIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/gnome.png");
        GNOME_CHILD = new ImageIcon(accountIcon);

        final BufferedImage deleteButton = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/deleteButton.png");
        DELETE_BUTTON = new ImageIcon(deleteButton);

        final BufferedImage highlightDeleteButton = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/highlightDeleteButton.png");
        HIGHLIGHT_DELETE_BUTTON = new ImageIcon(highlightDeleteButton);


        final BufferedImage starOn = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/star-gold.png");
        final BufferedImage starOff = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/star_off_white.png");
        ...
        final BufferedImage arrowLeft = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/left-arrow.png");
        ARROW_LEFT = new ImageIcon(ImageUtil.alphaOffset(arrowLeft,0.70f));

        final BufferedImage arrowRight = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/right-arrow.png");
        ...
        final BufferedImage heart = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/heart.png");
        HEART_ICON = new ImageIcon(heart);

        final BufferedImage trashIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/trash.png");
        TRASH_ICON = new ImageIcon(trashIcon);
        TRASH_ICON_OFF = new ImageIcon(ImageUtil.alphaOffset(trashIcon, 0.53f));

        final BufferedImage downloadIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/download.png");
        DOWNLOAD_ICON = new ImageIcon(downloadIcon);
        DONWLOAD_ICON_OFF = new ImageIcon(ImageUtil.alphaOffset(downloadIcon, 0.53f));

        final BufferedImage githubIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/github-alch.png");
        final BufferedImage githubIconOn = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/githubon.png");
        GITHUB_ICON = new ImageIcon(githubIcon);
        GITHUB_ICON_ON = new ImageIcon(githubIconOn);

        final BufferedImage twitterIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/twitter-alch.png");
        ...
        final BufferedImage discordIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/discord-alch.png");
        final BufferedImage discordIconOn = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/discordon.png");
        final BufferedImage discordCheese = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/discord-cheese.png");
        ...
        final BufferedImage plusIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/plus.png");
        ...
        final BufferedImage greenDot = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/greendot.png");
        GREEN_DOT = new ImageIcon(greenDot.getScaledInstance(OPTION_DOT_WIDTH,OPTION_DOT_HEIGHT,Image.SCALE_SMOOTH));

        final BufferedImage grayDot = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/graydot.png");
        GRAY_DOT = new ImageIcon(grayDot.getScaledInstance(OPTION_DOT_WIDTH,OPTION_DOT_HEIGHT,Image.SCALE_SMOOTH));

        final BufferedImage redDot = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/reddot.png");
        RED_DOT = new ImageIcon(redDot.getScaledInstance(OPTION_DOT_WIDTH,OPTION_DOT_HEIGHT,Image.SCALE_SMOOTH));

        final BufferedImage help = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/help.png");
        HELP = new ImageIcon(help);
        HELP_HOVER = new ImageIcon(ImageUtil.alphaOffset(help, 0.53f));

        final BufferedImage template = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/template.png");
        TEMPLATE = new ImageIcon(template);
        TEMPLATE_HOVER = new ImageIcon(ImageUtil.alphaOffset(template, 0.53f));

        final BufferedImage quantityEditorPic = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/quantityeditorpic.png");
        QUANTITY_EDITOR_PIC = new ImageIcon(quantityEditorPic);

        final BufferedImage priceEditorPic = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/priceeditorpic.png");
        PRICE_EDITOR_PIC = new ImageIcon(priceEditorPic);

        final BufferedImage searchIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/search.png");
        SEARCH = new ImageIcon(searchIcon.getScaledInstance(12,12,Image.SCALE_SMOOTH));

        final BufferedImage searchIconHover = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/search.png");
        SEARCH_HOVER = new ImageIcon(ImageUtil.alphaOffset(searchIconHover,.53f).getScaledInstance(12,12,Image.SCALE_SMOOTH));

        final BufferedImage refreshIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/refresh.png");
        REFRESH = new ImageIcon(refreshIcon.getScaledInstance(12,12,Image.SCALE_SMOOTH));

        final BufferedImage refreshIconHover = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/refresh.png");
        REFRESH_HOVER = new ImageIcon(ImageUtil.alphaOffset(refreshIconHover,.53f).getScaledInstance(12,12,Image.SCALE_SMOOTH));

        final BufferedImage toggleOn = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/toggle_on.png");
        ...
        final BufferedImage trashCanIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/trashicon.png");
        ...
        final BufferedImage questionMark = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/question-mark.png");
        QUESTION_MARK = new ImageIcon(questionMark);

        final BufferedImage userIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/user-alch.png");
        final BufferedImage userIconCheese = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/user-cheese.png");
        final BufferedImage userIconLoggedIn = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/user-loggedin.png");
        USER_HOVER = new ImageIcon(userIconCheese);
        USER = new ImageIcon(userIcon);
        USER_LOGGED_IN = new ImageIcon(userIconLoggedIn);

        final BufferedImage fuIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/graph_icon_green.png");
        FU_ICON = new ImageIcon(fuIcon);

        final BufferedImage keyIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/key.png");
        KEY = new ImageIcon(keyIcon);

        final BufferedImage flashIcon = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/flash-cheese.png");
        FLASH = new ImageIcon(flashIcon);

        final BufferedImage rightArrowLarge = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/right-arrow-large.png");
        RIGHT_ARROW_LARGE = new ImageIcon(rightArrowLarge);

        final BufferedImage leftArrowLarge = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/left-arrow-large.png");
        LEFT_ARROW_LARGE = new ImageIcon(leftArrowLarge);

        final BufferedImage sort = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/sort.png");
        SORT = new ImageIcon(ImageUtil.alphaOffset(sort, 0.53f));

        final BufferedImage sortHover = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/sort.png");
        SORT_HOVER = new ImageIcon(sort);

        final BufferedImage construction = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/construction.png");
        CONSTRUCTION = new ImageIcon(construction);

        final BufferedImage recipeHelp = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/recipehelp.png");
        RECIPE_HELP = new ImageIcon(recipeHelp);

        final BufferedImage magnifyingGlass = ImageUtil.loadImageResource(FlippingPlugin.class, "/net/runelite/client/plugins/flippingutilities/magnifying-glass.png");
