...
import net.runelite.client.plugins.flippingcopilot.ui.graph.PriceGraphController;
...
public class SuggestionPanel extends JPanel {
    ...
    private final JLabel suggestionIcon = new JLabel(new ImageIcon(ImageUtil.loadImageResource(getClass(),"/net/runelite/client/plugins/flippingcopilot/small_open_arrow.png")));
    ...
    public SuggestionPanel(FlippingCopilotConfig config,
        ...
        BufferedImage gearIcon = ImageUtil.loadImageResource(getClass(), "/net/runelite/client/plugins/flippingcopilot/preferences-icon.png");
...
//        Manager.showPriceGraph(graphButton, data);
    ...
    private void setupButtonContainer() {
        ...
        BufferedImage graphIcon = ImageUtil.loadImageResource(getClass(), "/net/runelite/client/plugins/flippingcopilot/graph.png");
        ...
        BufferedImage skipIcon = ImageUtil.loadImageResource(getClass(), "/net/runelite/client/plugins/flippingcopilot/skip.png");
