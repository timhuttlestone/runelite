...
public class SuggestionPanel extends JPanel {
    ...
    private void setupGraphButton() {
        BufferedImage graphIcon = ImageUtil.loadImageResource(getClass(),
            "/net/runelite/client/plugins/flippingcopilot/graph.png");
    ...
    private void setupSkipButton() {
        BufferedImage graphIcon = ImageUtil.loadImageResource(getClass(),
            "/net/runelite/client/plugins/flippingcopilot/skip.png");
